...
form.addEventListener('submit', function(e) {
    ...
    ex1 == "is" ? iconAnswer1.classList.add("fa-circle-check") : iconAnswer1.classList.add("fa-circle-xmark");
    ex2 == "is" ? iconAnswer2.classList.add("fa-circle-check") : iconAnswer2.classList.add("fa-circle-xmark");
    ex3 == "are" ? iconAnswer3.classList.add("fa-circle-check") : iconAnswer3.classList.add("fa-circle-xmark");
    ex4 == "am" ? iconAnswer4.classList.add("fa-circle-check") : iconAnswer4.classList.add("fa-circle-xmark");
    ex5 == "are" ? iconAnswer5.classList.add("fa-circle-check") : iconAnswer5.classList.add("fa-circle-xmark");
    ex6 == "is" ? iconAnswer6.classList.add("fa-circle-check") : iconAnswer6.classList.add("fa-circle-xmark");
    ex7 == "is" ? iconAnswer7.classList.add("fa-circle-check") : iconAnswer7.classList.add("fa-circle-xmark");
    ex8 == "are" ? iconAnswer8.classList.add("fa-circle-check") : iconAnswer8.classList.add("fa-circle-xmark");
    ex9 == "am" ? iconAnswer9.classList.add("fa-circle-check") : iconAnswer9.classList.add("fa-circle-xmark");
    ex10 == "are" ? iconAnswer10.classList.add("fa-circle-check") : iconAnswer10.classList.add("fa-circle-xmark");
});
